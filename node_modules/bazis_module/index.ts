...
export module geometry{
     ...
     * @param num 
     */
    export function vectorDivide(v: Vector, num: number): Vector{
        return {x: v.x / num,
                y: v.y / num,
                z: v.z / num}
    }
     ...
     * @param num 
     */
    export function vectorMultiply(v: Vector, num: number): Vector{
        return {x: v.x * num,
                y: v.y * num,
                z: v.z * num};
    }
     ...
     * @param lineStart Точка на линии 
     * @param lineDir Вектор направления линии
     */
    export function pointLineClosestPoint(point: Vector, lineStart: Vector, lineDir: Vector){
        let w = vectorSub(point, lineStart);
        let b = VectorDot(w, lineDir) / VectorDot(lineDir, lineDir);
        return vectorAdd(lineStart, vectorMultiply(lineDir, b))
    }
    /**
     * Проверка равности векторов
     * @param v1 
     * @param v2 
     */
     ...
     * @param v2 
     */
    export function vectorsCollinear(v1: Vector, v2: Vector): boolean{
        return Math.abs(VectorDot(v1, v2)) > 1 - eps;
    }
}